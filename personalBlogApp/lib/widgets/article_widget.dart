import 'package:djangoblogapp/screens/Article.dart';
...
import 'package:djangoblogapp/screens/single_article.dart';
              ...
              children: [
                ...
                InkWell(
                  onTap: (){
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Article(category: article.category.toLowerCase(), slug: article.slug,)));
                  },
                  child: Text(
                    article.title,
